...
NS.DUNGEON_LOOT = {
    ...
    ALGETHAR = {
        { itemId = 193703, slot = 1, itemName = "Organized Pontificator's Mask" },
        { itemId = 193704, slot = 3, itemName = "Scaled Commencement Spaulders" },
        { itemId = 193705, slot = 5, itemName = "Breastplate of Proven Knowledge" },
        { itemId = 193720, slot = 5, itemName = "Bronze Challenger's Robe" },
        { itemId = 193722, slot = 6, itemName = "Azure Belt of Competition" },
        { itemId = 193706, slot = 7, itemName = "Venerated Professor's Greaves" },
        { itemId = 193715, slot = 8, itemName = "Boots of Explosive Growth" },
        { itemId = 193714, slot = 9, itemName = "Frenzyroot Cuffs" },
        { itemId = 193713, slot = 10, itemName = "Experimental Safety Gloves" },
        { itemId = 193721, slot = 10, itemName = "Ruby Contestant's Gloves" },
        { itemId = 193708, slot = 11, itemName = "Platinum Star Band" },
        { itemId = 193701, slot = 13, itemName = "Algeth'ar Puzzle Box" },
        { itemId = 193718, slot = 13, itemName = "Emerald Coach's Whistle" },
        { itemId = 193719, slot = 13, itemName = "Dragon Games Equipment" },
        { itemId = 193712, slot = 15, itemName = "Potion-Stained Cloak" },
        { itemId = 193707, slot = 16, itemName = "Final Grade" },
        { itemId = 193710, slot = 16, itemName = "Spellboon Saber" },
        { itemId = 193711, slot = 16, itemName = "Spellbane Cutlass" },
        { itemId = 193716, slot = 16, itemName = "Algeth'ar Hedgecleaver" },
        { itemId = 193717, slot = 16, itemName = "Mystakra's Harvester" },
        { itemId = 193723, slot = 16, itemName = "Obsidian Goaltending Spire" },
        { itemId = 193709, slot = 17, itemName = "Vexamus' Expulsion Rod" },
    },
    -- Magisters' Terrace (26 items)
    MAGISTER = {
        { itemId = 251109, slot = 1, itemName = "Spellsnap Shadowmask" },
        { itemId = 251119, slot = 1, itemName = "Vortex Visage" },
        { itemId = 251101, slot = 5, itemName = "Arcane Guardian's Shell" },
        { itemId = 251114, slot = 5, itemName = "Voidwarped Oozemail" },
        { itemId = 251120, slot = 5, itemName = "Wraps of Umbral Descent" },
        { itemId = 251102, slot = 6, itemName = "Clasp of Compliance" },
        { itemId = 251110, slot = 6, itemName = "Sunlash's Sunsash" },
        { itemId = 251112, slot = 6, itemName = "Shadowsplit Girdle" },
        { itemId = 251104, slot = 7, itemName = "Leggings of Orderly Conduct" },
        { itemId = 251118, slot = 7, itemName = "Legplates of Lingering Dusk" },
        { itemId = 251107, slot = 8, itemName = "Oathsworn Stompers" },
        { itemId = 251121, slot = 8, itemName = "Domanaar's Dire Treads" },
        { itemId = 251103, slot = 9, itemName = "Custodial Cuffs" },
        { itemId = 251108, slot = 9, itemName = "Wraps of Watchful Wrath" },
        { itemId = 251113, slot = 10, itemName = "Gloves of Viscous Goo" },
        { itemId = 251115, slot = 11, itemName = "Bifurcation Band" },
        { itemId = 250242, slot = 13, itemName = "Jelly Replicator" },
        { itemId = 250246, slot = 13, itemName = "Refueling Orb" },
        { itemId = 250257, slot = 13, itemName = "Eye of the Drowning Void" },
        { itemId = 260312, slot = 15, itemName = "Defiant Defender's Drape" },
        { itemId = 251100, slot = 16, itemName = "Malfeasance Mallet" },
        { itemId = 251106, slot = 16, itemName = "Resolute Runeglaive" },
        { itemId = 251111, slot = 16, itemName = "Splitshroud Stinger" },
        { itemId = 251117, slot = 16, itemName = "Whirling Voidcleaver" },
        { itemId = 251122, slot = 16, itemName = "Shadowslash Slicer" },
        { itemId = 251105, slot = 17, itemName = "Ward of the Spellbreaker" },
    },
    -- Maisara Caverns (20 items)
    MAISARA = {
        { itemId = 251177, slot = 1, itemName = "Fetid Vilecrown" },
        { itemId = 251164, slot = 3, itemName = "Amalgamation's Harness" },
        { itemId = 251171, slot = 3, itemName = "Enthralled Bonespines" },
        { itemId = 251176, slot = 3, itemName = "Reanimator's Weight" },
        { itemId = 251179, slot = 5, itemName = "Decaying Cuirass" },
        { itemId = 251166, slot = 6, itemName = "Falconer's Cinch" },
        { itemId = 251170, slot = 7, itemName = "Wickedweave Trousers" },
        { itemId = 251167, slot = 8, itemName = "Nightprey Stalkers" },
        { itemId = 251169, slot = 8, itemName = "Footwraps of Ill-Fate" },
        { itemId = 263193, slot = 9, itemName = "Trollhunter's Bands" },
        { itemId = 251172, slot = 10, itemName = "Vilehex Bonds" },
        { itemId = 250223, slot = 13, itemName = "Soulcatcher's Charm" },
        { itemId = 250258, slot = 13, itemName = "Vessel of Tortured Souls" },
        { itemId = 251161, slot = 15, itemName = "Soulhunter's Mask" },
        { itemId = 251162, slot = 16, itemName = "Traitor's Talon" },
        { itemId = 251163, slot = 16, itemName = "Berserker's Hexclaws" },
        { itemId = 251168, slot = 16, itemName = "Liferipper's Cutlass" },
        { itemId = 251174, slot = 16, itemName = "Deceiver's Rotbow" },
        { itemId = 251175, slot = 16, itemName = "Soulblight Cleaver" },
        { itemId = 251178, slot = 16, itemName = "Ceremonial Hexblade" },
    },
    -- Nexus-Point Xenas (20 items)
    NEXUS_XENAS = {
        { itemId = 251157, slot = 3, itemName = "Searing Spaulders" },
        { itemId = 251213, slot = 3, itemName = "Nysarra's Mantle" },
        { itemId = 251216, slot = 5, itemName = "Maledict Vest" },
        { itemId = 251205, slot = 7, itemName = "Leyline Leggings" },
        { itemId = 251208, slot = 7, itemName = "Lightscarred Cuisses" },
        { itemId = 251215, slot = 7, itemName = "Greaves of the Divine Guile" },
        { itemId = 251210, slot = 8, itemName = "Eclipse Espadrilles" },
        { itemId = 251203, slot = 9, itemName = "Kasreth's Bindings" },
        { itemId = 251209, slot = 9, itemName = "Corewarden Cuffs" },
        { itemId = 251204, slot = 10, itemName = "Corewright's Zappers" },
        { itemId = 251211, slot = 10, itemName = "Fractured Fingerguards" },
        { itemId = 251093, slot = 11, itemName = "Omission of Light" },
        { itemId = 251217, slot = 11, itemName = "Occlusion of Void" },
        { itemId = 250241, slot = 13, itemName = "Mark of Light" },
        { itemId = 250253, slot = 13, itemName = "Whisper of the Duskwraith" },
        { itemId = 251206, slot = 15, itemName = "Fluxweave Cloak" },
        { itemId = 251201, slot = 16, itemName = "Corespark Multitool" },
        { itemId = 251207, slot = 16, itemName = "Dreadflail Bludgeon" },
        { itemId = 251212, slot = 16, itemName = "Radiant Slicer" },
        { itemId = 251202, slot = 17, itemName = "Reflux Reflector" },
    },
    -- Pit of Saron (23 items)
    PIT_OF_SARON = {
        { itemId = 49819, slot = 1, itemName = "Skeleton Lord's Cranium" },
        { itemId = 49824, slot = 1, itemName = "Horns of the Spurned Val'kyr" },
        { itemId = 50228, slot = 2, itemName = "Barbed Ymirheim Choker" },
        { itemId = 50233, slot = 3, itemName = "Spurned Val'kyr Shoulderguards" },
        { itemId = 50234, slot = 3, itemName = "Shoulderplates of Frozen Blood" },
        { itemId = 49825, slot = 5, itemName = "Palebone Robes" },
        { itemId = 50272, slot = 5, itemName = "Frost Wyrm Ribcage" },
        { itemId = 49806, slot = 6, itemName = "Flayer's Black Belt" },
        { itemId = 49808, slot = 6, itemName = "Bent Gold Belt" },
        { itemId = 49810, slot = 6, itemName = "Scabrous Zombie Leather Belt" },
        { itemId = 50263, slot = 6, itemName = "Braid of Salt and Fire" },
        { itemId = 49817, slot = 7, itemName = "Shaggy Wyrmleather Leggings" },
        { itemId = 133489, slot = 8, itemName = "Ice-Steeped Sandals" },
        { itemId = 50264, slot = 9, itemName = "Chewed Leather Wristguards" },
        { itemId = 133493, slot = 9, itemName = "Wristguards of Subterranean Moss" },
        { itemId = 49812, slot = 11, itemName = "Purloined Wedding Ring" },
        { itemId = 50259, slot = 13, itemName = "Nevermelting Ice Crystal" },
        { itemId = 252421, slot = 13, itemName = "Rotting Globule" },
        { itemId = 49823, slot = 15, itemName = "Cloak of the Fallen Cardinal" },
        { itemId = 49802, slot = 16, itemName = "Garfrost's Two-Ton Hammer" },
        { itemId = 49813, slot = 16, itemName = "Rimebane Rifle" },
        { itemId = 50227, slot = 16, itemName = "Surgeon's Needle" },
        { itemId = 133491, slot = 16, itemName = "Krick's Beetle Stabber" },
    },
    -- The Seat of the Triumvirate (31 items)
    SEAT = {
        { itemId = 151333, slot = 1, itemName = "Crown of the Dark Envoy" },
        { itemId = 151336, slot = 1, itemName = "Voidlashed Hood" },
        { itemId = 151337, slot = 1, itemName = "Shadow-Weaver's Crown" },
        { itemId = 151309, slot = 2, itemName = "Necklace of the Twisting Void" },
        { itemId = 151319, slot = 3, itemName = "Twilight's Edge Spaulders" },
        { itemId = 151323, slot = 3, itemName = "Pauldrons of the Void Hunter" },
        { itemId = 151303, slot = 5, itemName = "Voidbender Robe" },
        { itemId = 151313, slot = 5, itemName = "Vest of the Void's Embrace" },
        { itemId = 151325, slot = 5, itemName = "Void-Linked Robe" },
        { itemId = 151329, slot = 5, itemName = "Breastplate of the Dark Touch" },
        { itemId = 151327, slot = 6, itemName = "Girdle of the Shadowguard" },
        { itemId = 151301, slot = 8, itemName = "Slippers of Growing Despair" },
        { itemId = 151317, slot = 8, itemName = "Footpads of Seeping Dread" },
        { itemId = 151320, slot = 8, itemName = "Void-Coated Stompers" },
        { itemId = 151330, slot = 8, itemName = "Trap Jammers" },
        { itemId = 151305, slot = 9, itemName = "Entropic Wristwraps" },
        { itemId = 151321, slot = 9, itemName = "Darkfang Scale Wristguards" },
        { itemId = 151328, slot = 9, itemName = "Vambraces of Lost Hope" },
        { itemId = 151300, slot = 10, itemName = "Handwraps of the Ascended" },
        { itemId = 151318, slot = 10, itemName = "Gloves of the Dark Shroud" },
        { itemId = 151322, slot = 10, itemName = "Void-Touched Grips" },
        { itemId = 151332, slot = 10, itemName = "Voidclaw Gauntlets" },
        { itemId = 151308, slot = 11, itemName = "Eredath Seal of Nobility" },
        { itemId = 151310, slot = 13, itemName = "Reality Breacher" },
        { itemId = 151312, slot = 13, itemName = "Ampoule of Pure Void" },
        { itemId = 151340, slot = 13, itemName = "Echo of L'ura" },
        { itemId = 258514, slot = 16, itemName = "Umbral Spire of Zuraal" },
        { itemId = 258516, slot = 16, itemName = "Wand of Saprish's Gaze" },
        { itemId = 258524, slot = 16, itemName = "Grips of the Dark Viceroy" },
        { itemId = 258525, slot = 16, itemName = "Scepter of the Endless Night" },
        { itemId = 258523, slot = 17, itemName = "Nezhar's Netherclaw" },
    },
    -- Skyreach (28 items)
    SKYREACH = {
        { itemId = 258579, slot = 1, itemName = "Gutcrusher Greathelm" },
        { itemId = 258585, slot = 1, itemName = "Sharpeye Gleam" },
        { itemId = 258578, slot = 3, itemName = "Lightbinder Shoulderguards" },
        { itemId = 258581, slot = 3, itemName = "Bloodfeather Mantle" },
        { itemId = 258587, slot = 3, itemName = "Spaulders of Scorching Ray" },
        { itemId = 258576, slot = 5, itemName = "Sharpeye Chestguard" },
        { itemId = 258586, slot = 5, itemName = "Bloodfeather Chestguard" },
        { itemId = 258574, slot = 7, itemName = "Legwraps of Swirling Light" },
        { itemId = 258577, slot = 8, itemName = "Boots of Burning Focus" },
        { itemId = 258582, slot = 8, itemName = "Rigid Scale Boots" },
        { itemId = 258584, slot = 8, itemName = "Lightbinder Treads" },
        { itemId = 258580, slot = 9, itemName = "Bracers of Blazing Light" },
        { itemId = 258583, slot = 10, itemName = "Incarnadine Gauntlets" },
        { itemId = 252411, slot = 13, itemName = "Radiant Sunstone" },
        { itemId = 252418, slot = 13, itemName = "Solar Core Igniter" },
        { itemId = 252420, slot = 13, itemName = "Solarflare Prism" },
        { itemId = 258575, slot = 15, itemName = "Rigid Scale Greatcloak" },
        { itemId = 258046, slot = 16, itemName = "Chakram-Breaker Greatsword" },
        { itemId = 258047, slot = 16, itemName = "Spire of the Furious Construct" },
        { itemId = 258048, slot = 16, itemName = "Beakbreaker Scimitar" },
        { itemId = 258050, slot = 16, itemName = "Arcanic of the High Sage" },
        { itemId = 258218, slot = 16, itemName = "Skybreaker's Blade" },
        { itemId = 258412, slot = 16, itemName = "Stormshaper's Crossbow" },
        { itemId = 258436, slot = 16, itemName = "Edge of the Burning Sun" },
        { itemId = 258438, slot = 16, itemName = "Blazing Sunclaws" },
        { itemId = 258484, slot = 16, itemName = "Sunlance of Viryx" },
        { itemId = 258049, slot = 17, itemName = "Viryx's Indomitable Bulwark" },
        { itemId = 258472, slot = 17, itemName = "Rukhran's Solar Reliquary" },
    },
    -- Windrunner Spire (26 items)
    WINDRUNNER = {
        { itemId = 251080, slot = 1, itemName = "Brambledawn Halo" },
        { itemId = 251098, slot = 1, itemName = "Fletcher's Faded Faceplate" },
        { itemId = 251096, slot = 2, itemName = "Pendant of Aching Grief" },
        { itemId = 251085, slot = 3, itemName = "Mantle of Dark Devotion" },
        { itemId = 251092, slot = 3, itemName = "Fallen Grunt's Mantle" },
        { itemId = 251097, slot = 3, itemName = "Spaulders of Arrow's Flight" },
        { itemId = 251099, slot = 5, itemName = "Vest of the Howling Gale" },
        { itemId = 251082, slot = 6, itemName = "Snapvine Cinch" },
        { itemId = 251086, slot = 6, itemName = "Riphook Defender" },
        { itemId = 251087, slot = 7, itemName = "Legwraps of Lingering Legacies" },
        { itemId = 251090, slot = 7, itemName = "Commander's Faded Breeches" },
        { itemId = 251084, slot = 8, itemName = "Whipcoil Sabatons" },
        { itemId = 251091, slot = 8, itemName = "Sabatons of Furious Revenge" },
        { itemId = 251079, slot = 9, itemName = "Amberfrond Bracers" },
        { itemId = 251081, slot = 10, itemName = "Embergrove Grasps" },
        { itemId = 251089, slot = 10, itemName = "Grips of Forgotten Honor" },
        { itemId = 250144, slot = 13, itemName = "Emberwing Feather" },
        { itemId = 250226, slot = 13, itemName = "Latch's Crooked Hook" },
        { itemId = 250227, slot = 13, itemName = "Kroluk's Warbanner" },
        { itemId = 250256, slot = 13, itemName = "Heart of Wind" },
        { itemId = 251077, slot = 16, itemName = "Roostwarden's Bough" },
        { itemId = 251078, slot = 16, itemName = "Emberdawn Defender" },
        { itemId = 251083, slot = 16, itemName = "Excavating Cudgel" },
        { itemId = 251088, slot = 16, itemName = "Warworn Cleaver" },
        { itemId = 251095, slot = 16, itemName = "Hurricane's Heart" },
        { itemId = 251094, slot = 17, itemName = "Sigil of the Restless Heart" },
    },
}
