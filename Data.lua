...
NS.BIS_MYTHIC = {
    DEATHKNIGHT_BLOOD = {
        [1] = 249970, -- Risen Nightmare's Cranium (Tier Set)
        [3] = 249968, -- Risen Nightmare's Shoulderblades (Tier Set)
        [5] = 249973, -- Risen Nightmare's Chestguard (Tier Set)
        [7] = 249969, -- Risen Nightmare's Legguards (Tier Set)
        ...
        [11] = 251513, -- Loa Worshiper's Band (Crafted by Jewelcrafting)
    },
    DEATHKNIGHT_FROST = {
        [1] = 249970, -- Risen Nightmare's Cranium (Tier Set)
        [5] = 249973, -- Risen Nightmare's Chestguard (Tier Set)
        [10] = 249971, -- Risen Nightmare's Gauntlets (Tier Set)
        [7] = 249969, -- Risen Nightmare's Legguards (Tier Set)
        [16] = 251168, -- Liferipper's Cutlass (Maisara Caverns)
    ...
    DEMONHUNTER_DEVOURER = {
        ...
        [5] = 250036, -- Devouring Reaver's Chassis (Tier Set)
    ...
    DEMONHUNTER_HAVOC = {
        ...
        [5] = 250036, -- Devouring Reaver's Chassis (Tier Set)
        [10] = 250034, -- Devouring Reaver's Essence Grips (Tier Set)
        [7] = 250032, -- Devouring Reaver's Pistons (Tier Set)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
    ...
    DEMONHUNTER_VENGEANCE = {
        [1] = 250033, -- Devouring Reaver's Intake (Tier Helm)
        [2] = 151309, -- Necklace of the Twisting Void (Seat of the Triumvirate)
        [3] = 250031, -- Devouring Reaver's Exhaustplates (Tier Shoulders)
        [15] = 260312, -- Defiant Defender's Drape (Magister's Terrace)
        [5] = 251216, -- Maledict Vest (Nexus-Point Xenas)
        [9] = 244576, -- Silvermoon Agent's Deflectors (Crafted by Leatherworking)
        [10] = 250034, -- Devouring Reaver's Essence Grips (Tier Gloves)
        [6] = 251166, -- Falconer's Cinch (Maisara Caverns)
        [7] = 250032, -- Devouring Reaver's Pistons (Tier Legs)
    ...
    DRUID_BALANCE = {
        [1] = 250024, -- Lightweaver's Antlers (Tier Set)
        [3] = 250022, -- Lightweaver's Mantle (Tier Set)
        [10] = 250025, -- Lightweaver's Claws (Tier Set)
        [7] = 250023, -- Lightweaver's Chausses (Tier Set)
        [16] = 245770, -- Aln'hara Cane (Crafted by Enchanting)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
        [15] = 260312, -- Defiant Defender's Drape (Magister's Terrace)
    ...
    DRUID_FERAL = {
        [1] = 250024, -- Lightweaver's Antlers (Tier Set)
        [5] = 244570, -- Silvermoon Agent's Coat (Crafted by Leatherworking)
        [10] = 250025, -- Lightweaver's Claws (Tier Set)
        [7] = 250023, -- Lightweaver's Chausses (Tier Set)
    ...
    DRUID_GUARDIAN = {
        [3] = 250022, -- Lightweaver's Mantle (Tier Set)
        [5] = 250027, -- Lightweaver's Raiment (Tier Set)
        [10] = 250025, -- Lightweaver's Claws (Tier Set)
        [7] = 250023, -- Lightweaver's Chausses (Tier Set)
    ...
    EVOKER_AUGMENTATION = {
        ...
        [3] = 249995, -- Spark of Obsidian's Mantle (Tier Set)
        [5] = 250000, -- Spark of Obsidian's Hauberk (Tier Set)
        [10] = 249998, -- Spark of Obsidian's Grasp (Tier Set)
        [7] = 249996, -- Spark of Obsidian's Greaves (Tier Set)
        [16] = 237849, -- Magister's Valediction (Crafted by Blacksmithing)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
    ...
    EVOKER_DEVASTATION = {
        [1] = 249997, -- Spark of Obsidian's Coif (Tier Set)
        [3] = 249995, -- Spark of Obsidian's Mantle (Tier Set)
        [10] = 249998, -- Spark of Obsidian's Grasp (Tier Set)
        [7] = 249996, -- Spark of Obsidian's Greaves (Tier Set)
    ...
    HUNTER_BEASTMASTERY = {
        [1] = 249988, -- Stormbreaker's Crest (Tier Set)
        [5] = 249991, -- Stormbreaker's Hauberk (Tier Set)
        [10] = 249989, -- Stormbreaker's Gauntlets (Tier Set)
        [7] = 249987, -- Stormbreaker's Leggings (Tier Set)
    ...
    HUNTER_SURVIVAL = {
        ...
        [10] = 249989, -- Stormbreaker's Gauntlets (Tier Set)
        [7] = 249987, -- Stormbreaker's Leggings (Tier Set)
        [16] = 237847, -- Blood Knight's Impetus (Crafted by Blacksmithing)
        [2] = 251096, -- Pendant of Aching Grief (Windrunner Spire)
        [3] = 151323, -- Pauldrons of the Void Hunter (Seat of the Triumvirate)
        [15] = 258575, -- Rigid Scale Greatcloak (Skyreach)
        [9] = 251079, -- Amberfrond Bracers (Windrunner Spire)
    ...
    MAGE_ARCANE = {
        [1] = 250060, -- Violet Tempest's Pinnacle (Tier Set)
        [3] = 250058, -- Violet Tempest's Epaulets (Tier Set)
        [5] = 250063, -- Violet Tempest's Vestment (Tier Set)
        [10] = 250061, -- Violet Tempest's Fingertips (Tier Set)
    ...
    MAGE_FIRE = {
        ...
        [3] = 250058, -- Violet Tempest's Epaulets (Tier Set)
        [10] = 250061, -- Violet Tempest's Fingertips (Tier Set)
        [7] = 250059, -- Violet Tempest's Trousers (Tier Set)
        [16] = 193710, -- Spellboon Saber (Algeth'ar Academy)
    ...
    MONK_BREWMASTER = {
        [1] = 250015, -- Stormwatcher's Headpiece (Tier Set)
        [3] = 250013, -- Stormwatcher's Shoulderguards (Tier Set)
        [10] = 250016, -- Stormwatcher's Handguards (Tier Set)
        [7] = 250014, -- Stormwatcher's Legguards (Tier Set)
        [16] = 237847, -- Blood Knight's Impetus (Crafted by Blacksmithing)
        [2] = 240950, -- Masterwork Sin'dorei Amulet (Crafted by Jewelcrafting)
        [15] = 251161, -- Soulhunter's Mask (Maisara Caverns)
        [9] = 50264, -- Chewed Leather Wristguards (Pit of Saron)
        [6] = 251082, -- Snapvine Cinch (Windrunner Spire)
    ...
    MONK_MISTWEAVER = {
        [3] = 250013, -- Stormwatcher's Shoulderguards (Tier Set)
        [5] = 250018, -- Stormwatcher's Tunic (Tier Set)
        [10] = 250016, -- Stormwatcher's Handguards (Tier Set)
        [7] = 250014, -- Stormwatcher's Legguards (Tier Set)
    ...
    PALADIN_HOLY = {
        [1] = 249961, -- Entombed Seraph's Casque (Tier Set)
        [3] = 249959, -- Entombed Seraph's Plumes (Tier Set)
        [5] = 249964, -- Entombed Seraph's Castigation (Tier Set)
        [10] = 249962, -- Entombed Seraph's Devotion (Tier Set)
        [16] = 237843, -- Magister's Mana Sword (Crafted by Blacksmithing)
    ...
    PALADIN_PROTECTION = {
        ...
        [3] = 249959, -- Entombed Seraph's Plumes (Tier Set)
        [10] = 249962, -- Entombed Seraph's Devotion (Tier Set)
        [7] = 249960, -- Entombed Seraph's Greaves (Tier Set)
        [16] = 237839, -- Spellbreaker's Blade (Crafted by Blacksmithing)
        [17] = 237831, -- Spellbreaker's Rebuke (Crafted by Blacksmithing)
        [8] = 237828, -- Spellbreaker's March (Crafted by Blacksmithing)
    },
    PALADIN_RETRIBUTION = {
        [1] = 249961, -- Entombed Seraph's Casque (Tier Set)
        [3] = 249959, -- Entombed Seraph's Plumes (Tier Set)
    ...
    PRIEST_DISCIPLINE = {
        [1] = 250051, -- Shattered Vow's Cranium (Tier Set)
        [5] = 250054, -- Shattered Vow's Vestment (Tier Set)
        [10] = 250052, -- Shattered Vow's Handwraps (Tier Set)
        [7] = 250050, -- Shattered Vow's Leggings (Tier Set)
    ...
    PRIEST_HOLY = {
        [1] = 250051, -- Shattered Vow's Cranium (Tier Set)
        [3] = 250049, -- Shattered Vow's Mantle (Tier Set)
        [10] = 250052, -- Shattered Vow's Handwraps (Tier Set)
        [7] = 250050, -- Shattered Vow's Leggings (Tier Set)
        [16] = 245770, -- Aln'hara Cane (Crafted by Enchanting)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
    ...
    ROGUE_ASSASSINATION = {
        [1] = 250006, -- Saboteur's Cowl (Tier Set)
        [3] = 250004, -- Saboteur's Pauldrons (Tier Set)
        [5] = 250009, -- Saboteur's Jacket (Tier Set)
        [10] = 250007, -- Saboteur's Gloves (Tier Set)
        [16] = 237837, -- Farstrider's Mercy (Crafted by Blacksmithing)
        [2] = 151309, -- Necklace of the Twisting Void (Seat of the Triumvirate)
        [15] = 260312, -- Defiant Defender's Drape (Magister's Terrace)
        [9] = 244576, -- Silvermoon Agent's Deflectors (Crafted by Leatherworking)
        [6] = 251082, -- Snapvine Cinch (Windrunner Spire)
    ...
    ROGUE_OUTLAW = {
        ...
        [5] = 250009, -- Saboteur's Jacket (Tier Set)
        [10] = 250007, -- Saboteur's Gloves (Tier Set)
        [7] = 250005, -- Saboteur's Leggings (Tier Set)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
        [15] = 260312, -- Defiant Defender's Drape (Magister's Terrace)
        [9] = 50264, -- Chewed Leather Wristguards (Pit of Saron)
        [6] = 251166, -- Falconer's Cinch (Maisara Caverns)
    ...
    SHAMAN_ELEMENTAL = {
        [1] = 249979, -- Stormrider's Headpiece (Tier Set)
        [3] = 249977, -- Stormrider's Shoulderguards (Tier Set)
        [5] = 249982, -- Stormrider's Hauberk (Tier Set)
        [10] = 249980, -- Stormrider's Grips (Tier Set)
    ...
    SHAMAN_RESTORATION = {
        ...
        [5] = 249982, -- Stormrider's Hauberk (Tier Set)
        [10] = 249980, -- Stormrider's Grips (Tier Set)
        [7] = 249978, -- Stormrider's Leggings (Tier Set)
        [16] = 251178, -- Ceremonial Hexblade (Maisara Caverns)
        [17] = 258049, -- Viryx's Indomitable Bulwark (Skyreach)
    ...
    WARLOCK_AFFLICTION = {
        [1] = 250042, -- Sinister Savant's Cranium (Tier Set)
        [5] = 250045, -- Sinister Savant's Vestment (Tier Set)
        [10] = 250043, -- Sinister Savant's Handwraps (Tier Set)
        [7] = 250041, -- Sinister Savant's Leggings (Tier Set)
    ...
    WARRIOR_ARMS = {
        [1] = 249952, -- Warbringer's Warhelm (Tier Set)
        [3] = 249950, -- Warbringer's Shoulderguards (Tier Set)
        [5] = 249955, -- Warbringer's Chestplate (Tier Set)
        [7] = 249951, -- Warbringer's Legguards (Tier Set)
        [16] = 237846, -- Blood Knight's Warblade (Crafted by Blacksmithing)
        [2] = 50228, -- Barbed Ymirheim Choker (Pit of Saron)
        [9] = 237834, -- Spellbreaker's Bracers (Crafted by Blacksmithing)
        [10] = 151332, -- Voidclaw Gauntlets (Seat of the Triumvirate)
        [6] = 49808, -- Bent Gold Belt (Pit of Saron)
